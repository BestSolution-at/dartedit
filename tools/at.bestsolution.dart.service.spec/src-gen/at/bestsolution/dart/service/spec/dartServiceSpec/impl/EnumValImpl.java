 ...
 * </p>
 * <ul>
 *   <li>{@link at.bestsolution.dart.service.spec.dartServiceSpec.impl.EnumValImpl#getDoc <em>Doc</em>}</li>
 *   <li>{@link at.bestsolution.dart.service.spec.dartServiceSpec.impl.EnumValImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumValImpl extends MinimalEObjectImpl.Container implements EnumVal
{
  ...
  {
    return DartServiceSpecPackage.Literals.ENUM_VAL;
  }
  ...
  public EList<String> getDoc()
  {
    if (doc == null)
    {
      doc = new EDataTypeEList<String>(String.class, this, DartServiceSpecPackage.ENUM_VAL__DOC);
    }
    return doc;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DartServiceSpecPackage.ENUM_VAL__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DartServiceSpecPackage.ENUM_VAL__DOC:
        return getDoc();
      case DartServiceSpecPackage.ENUM_VAL__NAME:
        return getName();
    }
