 ...
 * </p>
 * <ul>
 *   <li>{@link at.bestsolution.dart.service.spec.dartServiceSpec.impl.GenericTypeArgumentImpl#getType <em>Type</em>}</li>
 *   <li>{@link at.bestsolution.dart.service.spec.dartServiceSpec.impl.GenericTypeArgumentImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link at.bestsolution.dart.service.spec.dartServiceSpec.impl.GenericTypeArgumentImpl#isList <em>List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenericTypeArgumentImpl extends MinimalEObjectImpl.Container implements GenericTypeArgument
{
  ...
  {
    return DartServiceSpecPackage.Literals.GENERIC_TYPE_ARGUMENT;
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DartServiceSpecPackage.GENERIC_TYPE_ARGUMENT__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(DomainElement newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DartServiceSpecPackage.GENERIC_TYPE_ARGUMENT__TYPE, oldType, type));
  }
  ...
  public EList<GenericTypeArgument> getArguments()
  {
    if (arguments == null)
    {
      arguments = new EObjectContainmentEList<GenericTypeArgument>(GenericTypeArgument.class, this, DartServiceSpecPackage.GENERIC_TYPE_ARGUMENT__ARGUMENTS);
    }
    return arguments;
  }
  ...
  public void setList(boolean newList)
  {
    ...
    list = newList;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DartServiceSpecPackage.GENERIC_TYPE_ARGUMENT__LIST, oldList, list));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DartServiceSpecPackage.GENERIC_TYPE_ARGUMENT__ARGUMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DartServiceSpecPackage.GENERIC_TYPE_ARGUMENT__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case DartServiceSpecPackage.GENERIC_TYPE_ARGUMENT__ARGUMENTS:
        return getArguments();
      case DartServiceSpecPackage.GENERIC_TYPE_ARGUMENT__LIST:
        return isList();
    }
