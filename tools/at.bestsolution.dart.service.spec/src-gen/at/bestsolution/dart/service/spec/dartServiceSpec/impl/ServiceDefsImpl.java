 ...
 * </p>
 * <ul>
 *   <li>{@link at.bestsolution.dart.service.spec.dartServiceSpec.impl.ServiceDefsImpl#getPackageName <em>Package Name</em>}</li>
 *   <li>{@link at.bestsolution.dart.service.spec.dartServiceSpec.impl.ServiceDefsImpl#getDomainElements <em>Domain Elements</em>}</li>
 *   <li>{@link at.bestsolution.dart.service.spec.dartServiceSpec.impl.ServiceDefsImpl#getServiceDefs <em>Service Defs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceDefsImpl extends MinimalEObjectImpl.Container implements ServiceDefs
{
  ...
  {
    return DartServiceSpecPackage.Literals.SERVICE_DEFS;
  }
  ...
  public void setPackageName(String newPackageName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DartServiceSpecPackage.SERVICE_DEFS__PACKAGE_NAME, oldPackageName, packageName));
  }
  ...
  public EList<DomainElement> getDomainElements()
  {
    ...
    {
      domainElements = new EObjectContainmentEList<DomainElement>(DomainElement.class, this, DartServiceSpecPackage.SERVICE_DEFS__DOMAIN_ELEMENTS);
    }
  ...
  public EList<ServiceDef> getServiceDefs()
  {
    if (serviceDefs == null)
    {
      serviceDefs = new EObjectContainmentEList<ServiceDef>(ServiceDef.class, this, DartServiceSpecPackage.SERVICE_DEFS__SERVICE_DEFS);
    }
    return serviceDefs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DartServiceSpecPackage.SERVICE_DEFS__DOMAIN_ELEMENTS:
        return ((InternalEList<?>)getDomainElements()).basicRemove(otherEnd, msgs);
      case DartServiceSpecPackage.SERVICE_DEFS__SERVICE_DEFS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DartServiceSpecPackage.SERVICE_DEFS__PACKAGE_NAME:
